...
```{r}
c_wo_national <- cases_death_by_district_and_date_2_                                                           %>% filter(Localite != "National")                                                                        %>% filter(Localite != "National  ")                                                                      %>% filter(Localite != "Mamou")                                                                           %>% filter(Localite != "Lab_")                                                                            %>% filter(Localite != "Kati")                                                                            %>% filter(Localite != "Tougu_")  %>%        filter(Localite != "Dabola and Djingaraye") %>%
  filter(Localite != "For_cariah")
```
```{r}
...
```
```{r}
ggplot(datafordeath, aes(datafordeath$Localite, datafordeath$numericvalue)) + geom_bar(stat = "identity")
